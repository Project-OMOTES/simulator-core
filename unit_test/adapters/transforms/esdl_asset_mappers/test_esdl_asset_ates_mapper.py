...
class TestEsdlAssetAtesMapper(unittest.TestCase):
    ...
    def test_to_entity_method(self):
        ...
        self.assertEqual(
            ...
            esdl_asset.get_property("aquiferTopDepth", ATES_DEFAULTS.aquifer_depth)[0],
        )
        self.assertEqual(
            ates_entity.aquifer_thickness,
            esdl_asset.get_property("aquiferThickness", ATES_DEFAULTS.aquifer_thickness)[0],
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            esdl_asset.get_property("aquiferNetToGross", ATES_DEFAULTS.aquifer_net_to_gross)[0],
        )
        self.assertEqual(
            ates_entity.aquifer_porosity,
            esdl_asset.get_property("aquiferPorosity", ATES_DEFAULTS.aquifer_porosity)[0],
        )
        self.assertEqual(
            ates_entity.aquifer_permeability,
            esdl_asset.get_property("aquiferPermeability", ATES_DEFAULTS.aquifer_permeability)[0],
        )
        self.assertEqual(
            ates_entity.aquifer_anisotropy,
            esdl_asset.get_property("aquiferAnisotropy", ATES_DEFAULTS.aquifer_anisotropy)[0],
        )
        self.assertEqual(
            ates_entity.salinity, esdl_asset.get_property("salinity", ATES_DEFAULTS.salinity)[0]
        )
        self.assertEqual(
            ates_entity.well_casing_size,
            esdl_asset.get_property("wellCasingSize", ATES_DEFAULTS.well_casing_size)[0],
        )
        self.assertEqual(
            ates_entity.well_distance,
            esdl_asset.get_property("wellDistance", ATES_DEFAULTS.well_distance)[0],
        )
