...
class TestDemandCluster(unittest.TestCase):
    ...
    def test_demand_cluster_create(self):
        ...
        self.assertEqual(demand_cluster.temperature_out, DEFAULT_TEMPERATURE)
        self.assertEqual(
            demand_cluster.temperature_in, DEFAULT_TEMPERATURE - DEFAULT_TEMPERATURE_DIFFERENCE
        )
        self.assertEqual(
            demand_cluster.temperature_in_target,
