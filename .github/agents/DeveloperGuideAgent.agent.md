...
argument-hint: Developer documentation goal, target file, page title, and implementation topic (for example: add a new entity-layer asset based on an existing solver asset, add a new solver asset and a new entity layer asset, control extension, add a new output format, simulation flow for contributors, testing strategy, writing documentation with the help of ai agents).
