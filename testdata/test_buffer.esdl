...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="Untitled EnergySystem with return network" description="" id="e7b009e1-8e4a-46d0-bb70-d08af7e17be3_with_return_network" esdlVersion="v2507" version="7">
  <instance xsi:type="esdl:Instance" id="e0c9b698-3bf3-47fe-aea0-9a120fa6ee89" name="Untitled Instance">
    <area xsi:type="esdl:Area" id="919c382f-a01d-492a-8290-daa942d03efa" name="Untitled Area">
      <asset xsi:type="esdl:HeatStorage" id="11cc503d-534c-45f6-89dc-d2a3f47299ff" name="HeatStorage_11cc" fillLevel="0.25" maxDischargeRate="500000.0" maxChargeRate="500000.0" volume="100.0">
        <geometry xsi:type="esdl:Point" lat="51.93587314997846" lon="4.2439547181129464"/>
        <port xsi:type="esdl:InPort" id="47d7c914-90cc-40b0-96e2-4c03634f6d6c" name="In" connectedTo="1514cadf-e297-4720-85e9-c1f96bfe2734" carrier="db75dded-49f5-4d9c-8172-f837b714476e_ret"/>
        <port xsi:type="esdl:OutPort" id="65c5f555-f82e-4410-96d4-37575a73888d" name="Out" carrier="db75dded-49f5-4d9c-8172-f837b714476e" connectedTo="beacdc3c-7215-40d2-ba46-88821f0ff21c"/>
      </asset>
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe2" name="Pipe2" innerDiameter="0.3127" outerDiameter="0.45" diameter="DN300" length="89.5" roughness="0.01" related="Pipe2_ret">
        <dataSource xsi:type="esdl:DataSource" name="Logstor Product Catalogue Version 2020.03" attribution="https://www.logstor.com/media/6506/product-catalogue-uk-202003.pdf"/>
        <costInformation xsi:type="esdl:CostInformation" id="07d6bb60-0bf8-49ef-a53c-d8e54a5337cb">
          <investmentCosts xsi:type="esdl:SingleValue" name="Combined investment and installation costs" id="2ec0bb0f-1e4f-472e-b2f7-6b5dcdcb1cf0" value="1962.1">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" unit="EURO" perUnit="METRE" description="Costs in EUR/m" id="b1705132-f33d-42ad-8526-8ee00ef4a5b0"/>
        ...
        <geometry xsi:type="esdl:Line">
          ...
          <point xsi:type="esdl:Point" lat="51.93567594613868" lon="4.242491908371449"/>
        </geometry>
        <port xsi:type="esdl:InPort" id="beacdc3c-7215-40d2-ba46-88821f0ff21c" name="In" carrier="db75dded-49f5-4d9c-8172-f837b714476e" connectedTo="65c5f555-f82e-4410-96d4-37575a73888d"/>
        <port xsi:type="esdl:OutPort" id="41e751f5-3c52-4e7d-be91-c7c7c3425c6e" name="Out" connectedTo="a596648e-43d3-45e5-8c41-ab2d2cbd8d58" carrier="db75dded-49f5-4d9c-8172-f837b714476e"/>
      </asset>
      <asset xsi:type="esdl:Joint" id="f0d6617d-9ec5-482f-9599-83657ac5c349" name="Joint_f0d6">
        <port xsi:type="esdl:InPort" id="a596648e-43d3-45e5-8c41-ab2d2cbd8d58" name="In" connectedTo="26db841a-59bd-4eb8-819d-4b69d2be37dc 41e751f5-3c52-4e7d-be91-c7c7c3425c6e" carrier="db75dded-49f5-4d9c-8172-f837b714476e"/>
        <port xsi:type="esdl:OutPort" id="046d2b15-1ede-4010-a333-3768722b43cb" name="Out" connectedTo="37c214b2-a33b-4640-ae12-901c01268d96" carrier="db75dded-49f5-4d9c-8172-f837b714476e"/>
        <geometry xsi:type="esdl:Point" lat="51.935677083060575" lon="4.242480173707009"/>
      </asset>
      <asset xsi:type="esdl:Pipe" id="Pipe3" name="Pipe3" innerDiameter="0.3127" outerDiameter="0.45" diameter="DN300" length="371.2" roughness="0.01" related="Pipe3_ret">
        <dataSource xsi:type="esdl:DataSource" name="Logstor Product Catalogue Version 2020.03" attribution="https://www.logstor.com/media/6506/product-catalogue-uk-202003.pdf"/>
        ...
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lat="51.935670778311504" lon="4.242484364658595"/>
      ...
      <asset xsi:type="esdl:Joint" id="cb46ee82-69b8-4bf9-befb-ebabdc16f71b" name="Joint_f0d6_ret">
        <geometry xsi:type="esdl:Point" lat="51.935766486374014" lon="4.24119707196951"/>
        <port xsi:type="esdl:OutPort" id="87607cd3-4dbc-4940-a879-adf935a8e025" name="ret_port" carrier="db75dded-49f5-4d9c-8172-f837b714476e_ret" connectedTo="5819a592-638f-450f-a5bc-7377ad796197 9c6a60d6-915c-4cd7-b7fe-7977249fc8e6"/>
        <port xsi:type="esdl:InPort" id="1a99e903-841d-41da-b473-c0343ee297c8" name="ret_port" carrier="db75dded-49f5-4d9c-8172-f837b714476e_ret" connectedTo="a3a0a6fe-795f-45e5-bbf0-45a2a2a7f919"/>
      </asset>
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.3127" outerDiameter="0.45" length="172.0" roughness="0.01" diameter="DN300" id="Pipe2_ret" name="Pipe2_ret" related="Pipe2">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lat="51.935765762879704" lon="4.24120830371976"/>
          <point xsi:type="esdl:Point" lat="51.93585826670005" lon="4.243713319301606"/>
        </geometry>
        <port xsi:type="esdl:InPort" id="9c6a60d6-915c-4cd7-b7fe-7977249fc8e6" name="In_ret" connectedTo="87607cd3-4dbc-4940-a879-adf935a8e025" carrier="db75dded-49f5-4d9c-8172-f837b714476e_ret"/>
        <port xsi:type="esdl:OutPort" id="1514cadf-e297-4720-85e9-c1f96bfe2734" name="Out_ret" connectedTo="47d7c914-90cc-40b0-96e2-4c03634f6d6c" carrier="db75dded-49f5-4d9c-8172-f837b714476e_ret"/>
      </asset>
      <asset xsi:type="esdl:Pipe" innerDiameter="0.3127" outerDiameter="0.45" length="369.8" roughness="0.01" diameter="DN300" id="Pipe3_ret" name="Pipe3_ret" related="Pipe3">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lat="51.93419531279822" lon="4.245964293595001"/>
          <point xsi:type="esdl:Point" lat="51.935759044717706" lon="4.241203274577857"/>
        </geometry>
