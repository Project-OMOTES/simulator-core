...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="course_model with return network" id="3b21ab49-fd94-4dda-878d-dcaf651ded78_with_return_network" description="basic" esdlVersion="v2111" version="10">
  ...
  <instance xsi:type="esdl:Instance" id="8db3337e-440e-48d1-b1e9-6f86c4f76320" name="Untitled instance">
    <area xsi:type="esdl:Area" id="a3f3b5d9-2faa-4862-a5b0-d02b219052dd" name="Untitled area">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe1_ret" diameter="DN80" name="Pipe1" innerDiameter="0.08" length="1533.2" id="Pipe1" outerDiameter="0.09">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe2_ret" diameter="DN200" name="Pipe2" innerDiameter="0.2" length="44.4" id="Pipe2" outerDiameter="0.21">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe3_ret" diameter="DN100" name="Pipe3" innerDiameter="0.1" length="1157.3" id="Pipe3" outerDiameter="0.11">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe4_ret" diameter="DN100" name="Pipe4" innerDiameter="0.1" length="2982.2" id="Pipe4" outerDiameter="0.11">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="52.02578372981452" lon="4.422471821308137"/>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe1" diameter="DN80" name="Pipe1_ret" innerDiameter="0.08" length="1533.2" id="Pipe1_ret" outerDiameter="0.09">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe2" diameter="DN200" name="Pipe2_ret" innerDiameter="0.2" length="44.4" id="Pipe2_ret" outerDiameter="0.21">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.400719145015912" lat="52.019180932421804" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe3" diameter="DN100" name="Pipe3_ret" innerDiameter="0.1" length="1157.3" id="Pipe3_ret" outerDiameter="0.11">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe4" diameter="DN100" name="Pipe4_ret" innerDiameter="0.1" length="2982.2" id="Pipe4_ret" outerDiameter="0.11">
        <geometry xsi:type="esdl:Line">
