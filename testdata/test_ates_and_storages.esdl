  ...
  <instance xsi:type="esdl:Instance" id="8db3337e-440e-48d1-b1e9-6f86c4f76320" name="Untitled instance">
    <area xsi:type="esdl:Area" id="a3f3b5d9-2faa-4862-a5b0-d02b219052dd" name="Untitled area">
      ...
      <asset xsi:type="esdl:Joint" name="Joint_086f" id="086f467d-afd5-4a87-aad2-0b03f185edef">
        ...
        <port xsi:type="esdl:OutPort" id="3a52317d-827b-4dc4-a6df-1b145bbb1736" name="Out" connectedTo="9a462e32-2e53-40ca-97eb-8394b6a3d131 3874047c-96e8-4555-902a-8646daf3f984 ed47b034-8cbb-481a-b910-aa788d515f3e" carrier="e96c4852-b2bc-43be-8fa7-5ae5e25a1883_ret"/>
      </asset>
      ...
      <asset xsi:type="esdl:Joint" name="Joint_526a" id="526a38b8-cf6c-407e-9a76-837d409fdf12">
        ...
        <port xsi:type="esdl:InPort" id="027db45e-289d-4611-94ba-95d04abec30f" name="In" connectedTo="23be2b8d-5f5a-471f-875f-b7e20997f7c5 7ca06d72-bb1d-41ac-9a19-6306fb33e10e 3e22b22a-ea32-4326-9166-a21dcac26365" carrier="bac202fe-7c5f-4623-8ade-badbc607a16e_ret"/>
      ...
      <asset xsi:type="esdl:HeatStorage" id="94db279c-2a87-4057-b453-bb8f052f2b41" name="HeatStorage_94db" fillLevel="0.5" volume="100.0">
        <geometry xsi:type="esdl:Point" lat="52.0199129377293" lon="4.413564205169679" CRS="WGS84"/>
        <port xsi:type="esdl:InPort" id="83f5d235-8c1b-43d8-b219-61facaab0cb8" name="In" connectedTo="a6ab0df9-6124-46a3-b2b6-53c168591be9" carrier="e96c4852-b2bc-43be-8fa7-5ae5e25a1883_ret"/>
        <port xsi:type="esdl:OutPort" id="76bb608c-f5c7-4347-959f-cd0b5d6386c6" name="Out" connectedTo="2aff790f-83cf-44ce-9dbd-8f044ccdb5c1" carrier="bac202fe-7c5f-4623-8ade-badbc607a16e_ret"/>
      </asset>
      <asset xsi:type="esdl:Pipe" id="59c209b7-a845-4eda-8046-e857ecdc948a" name="Pipe_59c2" innerDiameter="0.1603" outerDiameter="0.25" diameter="DN150" length="355.6">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="b0283973-05aa-43c9-a5b2-07e3cbd581a9">
          <investmentCosts xsi:type="esdl:SingleValue" name="Combined investment and installation costs" id="f262258a-a071-45d8-b6fe-f765a1ab8693" value="1126.4">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" unit="EURO" perUnit="METRE" description="Costs in EUR/m" id="e95fd4af-a27c-4b2d-b959-cec880ff0a23"/>
          </investmentCosts>
        </costInformation>
        <material xsi:type="esdl:CompoundMatter" compoundType="LAYERED">
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.004">
            <matter xsi:type="esdl:Material" name="steel" id="8d23cee0-0332-4b71-a665-027318174686" thermalConductivity="52.15"/>
          </component>
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.03725">
            <matter xsi:type="esdl:Material" name="PUR" id="773fc262-6a2b-4f95-859e-d3157c9e7e61" thermalConductivity="0.027"/>
          </component>
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.0036">
            <matter xsi:type="esdl:Material" name="HDPE" id="e1e9ae48-5fe2-40de-99da-e75fa986c9e0" thermalConductivity="0.4"/>
          </component>
        </material>
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="52.021827590527295" lon="4.409401416778565"/>
          <point xsi:type="esdl:Point" lat="52.0199129377293" lon="4.413564205169679"/>
        </geometry>
        <port xsi:type="esdl:InPort" id="ed47b034-8cbb-481a-b910-aa788d515f3e" name="In" connectedTo="3a52317d-827b-4dc4-a6df-1b145bbb1736" carrier="e96c4852-b2bc-43be-8fa7-5ae5e25a1883_ret"/>
        <port xsi:type="esdl:OutPort" id="a6ab0df9-6124-46a3-b2b6-53c168591be9" name="Out" connectedTo="83f5d235-8c1b-43d8-b219-61facaab0cb8" carrier="e96c4852-b2bc-43be-8fa7-5ae5e25a1883_ret"/>
      </asset>
      <asset xsi:type="esdl:Pipe" id="5cde419a-401d-4041-a3cd-166ef60d1038" name="Pipe_5cde" innerDiameter="0.1603" outerDiameter="0.25" diameter="DN150" length="457.2">
        <dataSource xsi:type="esdl:DataSource" name="Logstor Product Catalogue Version 2020.03" attribution="https://www.logstor.com/media/6506/product-catalogue-uk-202003.pdf"/>
        <costInformation xsi:type="esdl:CostInformation" id="2ddaecfa-2a99-4c37-9572-23cc972dc722">
          <investmentCosts xsi:type="esdl:SingleValue" name="Combined investment and installation costs" id="56fdbddb-8a8e-4662-b787-04412d7c8a8b" value="1126.4">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" unit="EURO" perUnit="METRE" description="Costs in EUR/m" id="a0dc2e91-b6a7-4b19-b83a-004a5e8a79d6"/>
          </investmentCosts>
        </costInformation>
        <material xsi:type="esdl:CompoundMatter" compoundType="LAYERED">
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.004">
            <matter xsi:type="esdl:Material" name="steel" id="14313b1c-cd05-4bdc-a676-16f76be38430" thermalConductivity="52.15"/>
          </component>
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.03725">
            <matter xsi:type="esdl:Material" name="PUR" id="400c737e-3c47-491a-8836-a352fd3ef2c3" thermalConductivity="0.027"/>
          </component>
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.0036">
            <matter xsi:type="esdl:Material" name="HDPE" id="dc13d653-6b5c-4dc6-9803-2e649a82870b" thermalConductivity="0.4"/>
          </component>
        </material>
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="52.0199129377293" lon="4.413564205169679"/>
          <point xsi:type="esdl:Point" lat="52.01968845582685" lon="4.411332607269288"/>
          <point xsi:type="esdl:Point" lat="52.02092969459241" lon="4.409766197204591"/>
          <point xsi:type="esdl:Point" lat="52.021920019967986" lon="4.4088220596313485"/>
        </geometry>
        <port xsi:type="esdl:InPort" id="2aff790f-83cf-44ce-9dbd-8f044ccdb5c1" name="In" connectedTo="76bb608c-f5c7-4347-959f-cd0b5d6386c6" carrier="bac202fe-7c5f-4623-8ade-badbc607a16e_ret"/>
        <port xsi:type="esdl:OutPort" id="3e22b22a-ea32-4326-9166-a21dcac26365" name="Out" connectedTo="027db45e-289d-4611-94ba-95d04abec30f" carrier="bac202fe-7c5f-4623-8ade-badbc607a16e_ret"/>
      </asset>
    </area>
  </instance>
</esdl:EnergySystem>
